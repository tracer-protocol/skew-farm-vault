...
import {PoolCommitter} from "tracer/implementation/PoolCommitter.sol";
import {L2Encoder} from "tracer/implementation/L2Encoder.sol";

import {IPoolCommitter} from "tracer/interfaces/IPoolCommitter.sol";
...
contract longVault {
    ...
    constructor(
        ...
        poolCommitter = PoolCommitter(_committer);
    ...
    function target() public view returns (uint256) {
        ...
        uint256 _skew = pool.shortBalance() / skew();
